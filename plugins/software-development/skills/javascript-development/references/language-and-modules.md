...
- Preserve live bindings, evaluation order, and side effects when reorganizing imports or exports.
- Account for cycles before moving initialization across modules.
