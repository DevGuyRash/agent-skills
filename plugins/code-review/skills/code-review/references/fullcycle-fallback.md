...
version: 2026.03.08 Preserve severity-bounded reopen and behavior-facing staleness handling across review, apply, and verify cycles.
...
version: 2026.03.08 Escalate a full-cycle reopen only when severity-bounded rules or staleness rules require it.
