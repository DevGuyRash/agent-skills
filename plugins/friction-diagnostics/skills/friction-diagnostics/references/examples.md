...
Failure classes below name _structural_ ways fields go wrong. They are classes, not phrases — avoiding the class matters, avoiding specific words does not.
