...
When exact roundtrip fidelity is impossible for a workbook surface, make that surface visible in query output instead of pretending it is safely mutable.
