...
Load this file when the question is really about distribution policy, not just syntax.

The right answer depends on who consumes the repo, how often outputs change, and how much git history growth you can tolerate.
